import type { AgChartLabelFormatterParams, AgChartLabelOptions, AgGradientFill, AgInitialStateLegendOptions, AgSeriesMarkerStyle, AgSeriesMarkerStylerParams, AgSeriesVisibilityChange, ISeriesMarker } from 'ag-charts-types';
...
export declare abstract class Series<TDatumIndex, TDatum extends SeriesNodeDatum<TDatumIndex>, TProps extends SeriesProperties<any>, TLabel = TDatum, TContext extends SeriesNodeDataContext<TDatumIndex, TDatum, TLabel> = SeriesNodeDataContext<TDatumIndex, TDatum, TLabel>> extends Observable implements ISeries<TDatum, TProps, TLabel> {
    ...
    pickNodeNearestDistantObject<T extends Node & DistantObject>(point: Point, items: Iterable<T>): {
        datum: any;
        distance: number;
    } | undefined;
