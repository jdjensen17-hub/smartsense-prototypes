 ...
 */
export declare function jsonDiff<T>(source: T, target: T, skip?: (keyof T)[]): Partial<T> | null;
/**
 ...
 */
export declare function deepClone<T>(source: T, shallow?: Set<string>): T;
/**
 ...
 */
export declare function jsonResolveOperations<T, P>(source: T, params: P, skip?: Set<string>): Record<string, any>;
