...
export interface DragAndDropContextProps<T = any> {
    ...
    onDragLeaveContainerHandler: (e: DragEvent, containerRef: React.MutableRefObject<HTMLElement | undefined>) => void;
}
export type DraggingPosition = DraggingPositionItem | DraggingPositionBetweenItems | DraggingPositionRoot;
